 ...
 */
export type FixAction = "set-description" | "set-variable-description" | "rename-variable" | "rename-node" | "update-variable" | "create-variable" | "create-collection";
...
//# sourceMappingURL=fix-types.d.ts.map