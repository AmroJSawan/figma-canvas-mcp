...
export const DEFAULT_WS_PORT = 9243;
...
const PORT_FILE_PREFIX = 'figma-canvas-mcp-';
/** Directory for port advertisement files — use /tmp on macOS/Linux so plugin UI scan path matches */
        ...
        try {
            ...
            for (const pid of pids) {
                ...
                try {
                    ...
                    if (cmdline.includes('figma-canvas-mcp') || cmdline.includes('figma_console_mcp') || cmdline.includes('local.js')) {
