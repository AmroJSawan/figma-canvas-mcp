...
export class FigmaDesktopConnector {
    ...
    async getConnections() { throw new Error('FigJam operations require WebSocket transport'); }
    // Slides operations — not supported via legacy CDP transport
    async listSlides() { throw new Error('Slides operations require WebSocket transport'); }
    async getSlideContent() { throw new Error('Slides operations require WebSocket transport'); }
    async createSlide() { throw new Error('Slides operations require WebSocket transport'); }
    async deleteSlide() { throw new Error('Slides operations require WebSocket transport'); }
    async duplicateSlide() { throw new Error('Slides operations require WebSocket transport'); }
    async getSlideGrid() { throw new Error('Slides operations require WebSocket transport'); }
    async reorderSlides() { throw new Error('Slides operations require WebSocket transport'); }
    async setSlideTransition() { throw new Error('Slides operations require WebSocket transport'); }
    async getSlideTransition() { throw new Error('Slides operations require WebSocket transport'); }
    async setSlidesViewMode() { throw new Error('Slides operations require WebSocket transport'); }
    async getFocusedSlide() { throw new Error('Slides operations require WebSocket transport'); }
    async focusSlide() { throw new Error('Slides operations require WebSocket transport'); }
